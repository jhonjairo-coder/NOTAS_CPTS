...
```shell-session
jhonmorales@htb[/htb]$ cat /etc/exports 
...
```shell-session
jhonmorales@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
jhonmorales@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
jhonmorales@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
jhonmorales@htb[/htb]$ mkdir target-NFS
jhonmorales@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
jhonmorales@htb[/htb]$ cd target-NFS
jhonmorales@htb[/htb]$ tree .
...
```shell-session
jhonmorales@htb[/htb]$ ls -l mnt/nfs/
...
```shell-session
jhonmorales@htb[/htb]$ ls -n mnt/nfs/
...
```shell-session
jhonmorales@htb[/htb]$ cd ..
jhonmorales@htb[/htb]$ sudo umount ./target-NFS
```